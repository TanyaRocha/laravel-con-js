			  ...
			  '<html>',
				...
				'<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
				  ...
				  '<tr>',
					...
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> ' + vTitulos[4] + ' </center></font></th>',
				...
				'<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
				   '<tr>',
					'<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> <center>SUBTOTAL </center></font></th>',
					'<th width="20%" scope="col" colspan="3" align="right" ><font face="Arial, Helvetica, sans-serif" size="1px">'+ vTitulos[7] +'</font></th>',
				  '</tr>',
				  '<tr>',
					'<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> <center>TOTAL A PAGAR</center></font></th>',
					'<th width="20%" scope="col" colspan="1" align="right" ><font face="Arial, Helvetica, sans-serif" size="1px">Bs. '+ vTitulos[10] +'</font></th>',
				  '</tr>',
				'</table>',
				'</body>',
			  '</html>'
