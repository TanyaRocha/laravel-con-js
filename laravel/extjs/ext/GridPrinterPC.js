 ...
 * });
 * 
 * Ext.ux.GridPrinterPC.print(grid);
 * 
 */

Ext.ux.GridPrinterPC = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterPC.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterPC.bodyTpl.apply(columns);
      ...
      '<html>',
        '<head>',
          ...
          '<link href="' + Ext.ux.GridPrinterPC.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
 ...
 //////////////////
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
          '<tr>',
            ...
            '<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"></font></th>',
            '<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> </font></th>',
          '</tr>',
          '<tr>',
            '<th scope="row" colspan="4"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> '+ vTitulos[0] +' <br>',
        '</center></font></th>',
          '</tr>',
        '</table>',
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
           '<tr>',
            '<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> </font></th>',
            '<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"></font></th>',
          '</tr>',
        '</table>',
        '</body>',
