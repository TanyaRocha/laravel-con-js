/**
 * @class GetIt.GridPrinterVntRecargaOtro
 ...
 * });
 * 
 * Ext.ux.GridPrinterVntRecargaOtro.print(grid);
 * 
 */

Ext.ux.GridPrinterVntRecargaOtro = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterVntRecargaOtro.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterVntRecargaOtro.bodyTpl.apply(columns);
      ...
      '<html>',
        '<head>',
          ...
          '<link href="' + Ext.ux.GridPrinterVntRecargaOtro.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
 ...
 //////////////////
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
		 ...
		 '</tr>',
		 '<tr>',
			'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> % DE DESCUENTO </center></font></th>',
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
           '<tr>',
            ...
            '<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px">Bs. '+ vTitulos[4] +'</font></th>',
          '</tr>',
        '</table>',
        '</body>',
      '</html>'
