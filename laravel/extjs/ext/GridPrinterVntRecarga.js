/**
 * @class GetIt.GridPrinterVntRecarga
 ...
 * });
 * 
 * Ext.ux.GridPrinterVntRecarga.print(grid);
 * 
 */

Ext.ux.GridPrinterVntRecarga = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterVntRecarga.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterVntRecarga.bodyTpl.apply(columns);
      ...
      '<html>',
        '<head>',
          ...
          '<link href="' + Ext.ux.GridPrinterVntRecarga.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
		...
		'<tr>',
			'<th width="25%" scope="col" colspan="2"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> NOTA DE RECARGA </center></font></th>',
		 ...
		 '</tr>',
          '<tr>',
            ...
            '<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> '+ vTitulos[0] +' </center></font></th>',
			'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> NIT </center></font></th>',
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
           '<tr>',
            '<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> <center>TOTAL </center></font></th>',
            '<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px">Bs. '+ vTitulos[3] +'</font></th>',
          '</tr>',
        '</table>',
        '</body>',
      '</html>'
