...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/extjs/ext/ext-all.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('/extjs/ext/resources/css/xtheme-blue.css')}}" />
    <script src="{{ asset('/extjs/ext/ext-base.js')}}" type="text/javascript"></script>
    <script src="{{asset('/extjs/ext/ext-all.js')}}" type="text/javascript"></script>
...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>FrontEnd-SIM</b></a>
        </div>
...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1>a <b><a href="https://github.com/acacha/adminlte-laravel">SIM</a></b></h1>
                <h3>G<a href="https://laravel.com/">AML</a> {{ trans('adminlte_lang::message.laravelpackage') }}
                    scaffolding/boilerplate {{ trans('adminlte_lang::message.to') }} <a href="https://almsaeedstudio.com/preview">AdminSIM</a> {{ trans('adminlte_lang::message.templatewith') }}
