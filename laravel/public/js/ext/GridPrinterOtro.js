 ...
 * });
 * 
 * Ext.ux.GridPrinterOtro.print(grid);
 * 
 */

Ext.ux.GridPrinterOtro = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterOtro.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterOtro.bodyTpl.apply(columns);
		...
		var html = new Ext.XTemplate( 
			  ...
			  '<html>',
				'<head>',
				  ...
				  '<link href="' + Ext.ux.GridPrinterOtro.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
				  '<title>SISTEMA MUNICIPAL DE GESTION DE PROCESOS</title>',
				'</head>',
				'<body>',
				...
				'<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
				   '<tr>',
						'<th width="25%" scope="col" colspan="4" align="center"><font face="Arial, Helvetica, sans-serif" size="1px"><center>NOTA DE VENTA</center></H5></td>',						
				  '</tr>',
				  
				  '<tr>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>% DE COMISION </center></font></th>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> '+ '---' + ' </center></font></th>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> CORRELATIVO </center></font></th>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center> ' + vTitulos[5] + ' </center></font></th>',			
				 '</tr>',		  
				  
				  '<tr>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>ALMACEN</center></font></th>',
				 ...
				 //
				 '<tr>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>RAZON SOCIAL</center></font></th>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>' + vTitulos[8] + vTitulos[9]  + vTitulos[7] + '</center></font></th>',
					'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>CI/NIT</center></font></th>',
				...
				'<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',				   
				  '<tr>',
					'<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> <center>TOTAL A PAGAR</center></font></th>',
					'<th width="20%" scope="col" colspan="1" align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> '+ vTitulos[10] +'</font></th>',
				  '</tr>',
				'</table>',
				'</body>',
			  '</html>'
