 ...
 * });
 * 
 * Ext.ux.GridPrinterBG.print(grid);
 * 
 */

Ext.ux.GridPrinterBG = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterBG.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterBG.bodyTpl.apply(columns);
		...
		var html = new Ext.XTemplate( 
			  ...
			  '<html>',
				'<head>',
				  ...
				  '<link href="' + Ext.ux.GridPrinterBG.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
				...
				'<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
				   '<tr>',
						'<th width="25%" scope="col" colspan="3" align="center"><font face="Arial, Helvetica, sans-serif" size="1px"><center>NOTA DE VENTA</center></H5></td>',
						'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>NRO </center></font></th>',						
				  '</tr>',
				  '<tr>',
				...
				'<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
				   '<tr>',
					...
					'<th width="20%" scope="col" colspan="3" align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> </font></th>',
				  '</tr>',
				'</table>',
				'</body>',
			  '</html>'
