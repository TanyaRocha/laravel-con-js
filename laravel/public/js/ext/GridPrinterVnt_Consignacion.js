/**
 * @class GetIt.GridPrinterVnt_Consignacion
 ...
 * });
 * 
 * Ext.ux.GridPrinterVnt_Consignacion.print(grid);
 * 
 */

Ext.ux.GridPrinterVnt_Consignacion = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterVnt_Consignacion.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterVnt_Consignacion.bodyTpl.apply(columns);
      ...
      '<html>',
        '<head>',
          ...
          '<link href="' + Ext.ux.GridPrinterVnt_Consignacion.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
		   '<tr>',
				'<th width="25%" scope="col" colspan="2" align="center"><font face="Arial, Helvetica, sans-serif" size="1px"><center>NOTA DE CONSIGNACION</center></H5></td>',
		 ...
		 '</tr>',
		 '<tr>',
			'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>NOMBRE</center></font></th>',
