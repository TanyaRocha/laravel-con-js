/**
 * @class GetIt.GridPrinterInterno
 ...
 * });
 * 
 * Ext.ux.GridPrinterInterno.print(grid);
 * 
 */

Ext.ux.GridPrinterInterno = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterInterno.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterInterno.bodyTpl.apply(columns);
	...
	'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',
      '<html>',
        '<head>',
          ...
          '<link href="' + Ext.ux.GridPrinterInterno.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
		   '<tr>',
				'<th width="25%" scope="col" colspan="4"><font face="Arial, Helvetica, sans-serif" size="1px"><center>NOTA DE REMISION</center></H5></td>',
	      '</tr>',
          '<tr>',
		 ...
		 '</tr>',
		 '<tr>',
			'<th width="25%" scope="col"><font face="Arial, Helvetica, sans-serif" size="1px"> <center>ALMACEN DESTINO</center></font></th>',
