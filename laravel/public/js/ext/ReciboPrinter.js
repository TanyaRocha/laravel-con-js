      ...
      '<html>',
        ...
        '<table width="100%" border="0" cellpadding="0" cellspacing="0">',
          '<tr>',
            ...
            '</center>',
              '<center>',
                '<p>Gobierno Autonomo Municipal de La Paz </p>',
                '<p>Bus La Paz </p>',
                '<p>&nbsp;</p>',
              '</center></th>',
          '</tr>',
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0">',
          ...
          '<tr>',
            '<th scope="row" colspan="4"><center>',
              '<strong><font size="1px" face="Arial, Helvetica, sans-serif">FORMULARIO: RECIBO DE INGRESO GIRO (ORIGINAL)   Nro. '+ vTitulos[7] + ' </font></strong>',
            '</center></th>',
          '</tr>',
        '</table>',
        '<br />',
        ...
        '<table border="1" cellspacing="0" class="pagedTable" cellpading="0" width="100%">',
            '<tr>',
            '<th width="20%"><font size="1px" face="Arial, Helvetica, sans-serif"> GIRO</font></th>',
            '<th width="20%"><font size="1px" face="Arial, Helvetica, sans-serif"> HERRAMIENTA</font></th>',
            '<th width="20%"><font size="1px" face="Arial, Helvetica, sans-serif"> CONFIRMADO</font></th>',
            '<th width="20%"><font size="1px" face="Arial, Helvetica, sans-serif"> FLUJO</font></th>',
            '<th width="20%"><font size="1px" face="Arial, Helvetica, sans-serif"> MONTO</font></th>',
          '</tr>',
          '<tr>',
            ...
            '<th scope="row"><font size="1px" face="Arial, Helvetica, sans-serif"> '+ vTitulos[3] + ' </font></th>',
          '</tr>',
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0">',
          ...
          '<tr>',
            '<th scope="row" colspan="4"><center>',
              '<strong><font size="1px" face="Arial, Helvetica, sans-serif">FORMULARIO: RECIBO DE INGRESO GIRO (COPIA)   Nro. '+ vTitulos[7] + ' </font></strong>',
            '</center></th>',
          '</tr>',
        '</table>',
        '<br />',
