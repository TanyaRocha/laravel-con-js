 ...
 * });
 * 
 * Ext.ux.GridPrinterSS.print(grid);
 * 
 */

Ext.ux.GridPrinterSS = {
    /**
    ...
    */
    print: function (grid, curl, stitulo) {
        ...
        var headings = Ext.ux.GridPrinterSS.headerTpl.apply(columns);
        var body = Ext.ux.GridPrinterSS.bodyTpl.apply(columns);
		...
		var html = new Ext.XTemplate( 
			  ...
			  '<html>',
				'<head>',
				  ...
				  '<link href="' + Ext.ux.GridPrinterSS.stylesheetPath + '" rel="stylesheet" type="text/css" media="screen,print" />',        
